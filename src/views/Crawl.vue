<template lang="html">
  <div >
    <audio preload="auto" autoplay>
      <source src="@/assets/Star_Wars_original_opening_crawl_1977.mp3" type="audio/mpeg">
    </audio>
    ...
    <div id="board">
      <div id="content">
        <p id="title">Episode {{selectedFilm.episode_id}}</p>
        <p id="subtitle">{{selectedFilm.title}}</p>
        <br>
